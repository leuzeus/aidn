...
function main() {
  try {
    ...
    assert(contract.schema_version === POSTGRES_RUNTIME_RELATIONAL_TARGET_SCHEMA_VERSION, "expected relational target schema version");
    ...
    assert(contract.target_entities.some((entity) => entity.name === "runtime_scope_registry" && entity.classification === "admin"), "expected runtime project context registry");
