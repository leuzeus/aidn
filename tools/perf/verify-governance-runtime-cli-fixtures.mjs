...
function main() {
  try {
    ...
    assert(runtimeDiagnostics.observed_artifact_summary?.complete === 5, "runtime governance diagnostics should report complete observed artifacts for the tracked fixture");
