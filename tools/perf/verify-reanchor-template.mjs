...
function main() {
  try {
    ...
    const files = {
      ...
      integrationRisk: path.join(root, "template", "docs_audit", "INTEGRATION-RISK.md"),
      handoffPacket: path.join(root, "template", "docs_audit", "HANDOFF-PACKET.md"),
      agentRoster: path.join(root, "template", "docs_audit", "AGENT-ROSTER.md"),
      agentAdapters: path.join(root, "template", "docs_audit", "AGENT-ADAPTERS.md"),
      agentHealthSummary: path.join(root, "template", "docs_audit", "AGENT-HEALTH-SUMMARY.md"),
      agentSelectionSummary: path.join(root, "template", "docs_audit", "AGENT-SELECTION-SUMMARY.md"),
      multiAgentStatus: path.join(root, "template", "docs_audit", "MULTI-AGENT-STATUS.md"),
      exampleExternalAgent: path.join(root, "template", "runtime_agents", "example-external-auditor.mjs"),
      coordinationSummary: path.join(root, "template", "docs_audit", "COORDINATION-SUMMARY.md"),
      coordinationLog: path.join(root, "template", "docs_audit", "COORDINATION-LOG.md"),
      userArbitration: path.join(root, "template", "docs_audit", "USER-ARBITRATION.md"),
