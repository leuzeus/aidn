...
The `v0.10.4` source includes canonical PostgreSQL artifact writes, checkpoint
...
- prefer a published tagged install (`#v0.10.4` after publication) for stable consumers; use a branch ref only when you explicitly want an in-flight runtime baseline
