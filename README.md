...
The `v0.10.9` source includes canonical PostgreSQL artifact writes, checkpoint
...
- prefer a published tagged install (`#v0.10.9` after publication) for stable consumers; use a branch ref only when you explicitly want an in-flight runtime baseline
