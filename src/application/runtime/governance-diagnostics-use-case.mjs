...
export const GOVERNANCE_RUNTIME_SURFACES = Object.freeze([
  ...
  { id: "runtime-db-migrate-write", linked_concepts: ["workspace", "coordination_record"] },
  { id: "runtime-persistence-migrate", linked_concepts: ["workspace", "coordination_record"] },
  { id: "runtime-persistence-migrate-write", linked_concepts: ["workspace", "coordination_record"] },
