...
export function mergeRepairLayerPayload(payload, repairLayer, options = {}) {
  ...
  return {
    ...
    session_links: repairLayer.session_links,
    ...
    summary: {
      ...
      session_links_count: repairLayer.session_links.length,
...
export function summarizeRepairLayer(repairLayer, options = {}) {
  ...
  return {
    ...
    session_links_count: Array.isArray(repairLayer?.session_links) ? repairLayer.session_links.length : 0,
