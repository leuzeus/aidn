...
export const IMPORTED_SECTION_POLICIES = freezeItems([
  ...
  },
  {
    ...
    nativeTarget: "docs/SPEC.md#SPEC-R10 + scaffold/docs_audit/PROJECT_WORKFLOW.md",
  ...
  },
  {
    ...
    classification: "native-core",
    multiAgentScope: "dispatch-scope",
    nativeTarget: "scaffold/docs_audit/incidents/TEMPLATE_INC_TMP.md + scaffold/docs_audit/PROJECT_WORKFLOW.md",
    canonicalParity: "covered",
  },
  {
    ...
    classification: "native-core",
    multiAgentScope: "dispatch-scope",
    nativeTarget: "docs/SPEC.md#SPEC-R10 + scaffold/docs_audit/incidents/TEMPLATE_INC_TMP.md",
    canonicalParity: "covered",
  },
  {
  ...
  },
  {
    ...
    classification: "native-core",
    multiAgentScope: "dispatch-scope",
    nativeTarget: "docs/SPEC.md#SPEC-R06 + scaffold/docs_audit/CONTINUITY_GATE.md",
    canonicalParity: "covered",
  },
  {
  ...
  },
  {
    ...
    classification: "native-core",
    multiAgentScope: "dispatch-scope",
    nativeTarget: "scaffold/docs_audit/CONTINUITY_GATE.md + cycle-create skill",
    canonicalParity: "covered",
  },
  {
