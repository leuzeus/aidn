...
- Lot 4 (TOC prep): rapport de contrainte active (`report-constraints`) + seuils dédiés (`CONSTRAINT_TARGETS`) + résumé Markdown CI (`constraint-summary`) avec vérification fixture dédiée.
